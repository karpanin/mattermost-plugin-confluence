...
export default class ConfluenceIcon extends React.PureComponent {
    render() {
        let iconStyle = {};
        ...
        return (
            <span className='MenuItem__icon'>
                ...
                >
                    <defs>
                        <linearGradient id='confluenceMenuGradientOne' x1='99.140087%' y1='112.708084%' x2='33.8589812%' y2='37.7549606%'>
                            <stop stopColor='#0052CC' offset='18%'/>
                            <stop stopColor='#2684FF' offset='100%'/>
                        </linearGradient>
                        <linearGradient id='confluenceMenuGradientTwo' x1='0.92569163%' y1='-12.5823074%' x2='66.1800713%' y2='62.3057471%'>
                            <stop stopColor='#0052CC' offset='18%'/>
                            <stop stopColor='#2684FF' offset='100%'/>
                        </linearGradient>
                    </defs>
                    <g>
                        <path
                            ...
                            fill='url(#confluenceMenuGradientOne)'
                        />
                        <path
                            ...
                            fill='url(#confluenceMenuGradientTwo)'
                        />
                    </g>
                </svg>
            </span>
